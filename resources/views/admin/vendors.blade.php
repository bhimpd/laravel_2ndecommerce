                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" class="btn btn-sm badge text-bg-danger"><i class="fa-solid fa-xmark"></i></a>    
                                  ...
                                  <tr>
                                    ...
                                    <td>victor.memo@gmail.com</td>
                                    <td>Pokhara</td>
                                    <td><span class="badge text-bg-danger">Inactive</span>
                                    </td>
                                    
                                    <td>
                                        <a href="#" class="btn btn-sm badge text-bg-success"><i class="fa-solid fa-check"></i></a>    
                                        <a href="#" class="btn btn-sm badge text-bg-danger"><i class="fa-solid fa-xmark"></i></a>    
